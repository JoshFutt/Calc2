...
document.getElementById('subtract').onclick = function(operation){populatehtml(subtract)};
document.getElementById('multiply').onclick = function(operation){populatehtml(multiply)};
document.getElementById('divide').onclick = function(operation){populatehtml(divide)};
